...
Fill `.agents/skills/bb-brainstorm/references/spec-template.md` using only the input gathered — no new sections, no extra files (no plan, no report, no code).
